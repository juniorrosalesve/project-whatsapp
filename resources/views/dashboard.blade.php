                    ...
                    @if ($messages != null)
                        ...
                        <div>
                            <div class="w-full flex justify-between bg-green-100">
                                <textarea class="flex-grow m-2 py-2 px-4 mr-1 rounded-full border border-gray-300 bg-gray-200 resize-none" rows="1" placeholder="" style="outline: none;"></textarea>
